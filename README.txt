...
a persistence unit "prueba63AbadPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "prueba63Abad/pom.xml":
...
artifact ("prueba63Abad.war") is already built. You can build
